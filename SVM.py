# -*- coding: utf-8 -*-
"""
Created on Wed Dec 11 14:15:48 2019
...
#As this field can have one of only two possible values, we need to change 
#its measurement level to reflect this.
